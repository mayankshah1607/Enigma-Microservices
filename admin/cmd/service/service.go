...
import (
	...
	http "evento_microservices/admin/pkg/http"
...
var fs = flag.NewFlagSet("admin", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "admin")
